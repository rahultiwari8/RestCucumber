...
public class getDetails {
	...
	{
		 excelObj = new Excelop("/Users/rahultiwari/Downloads/Cucumber.RA.framework-master/RestAssured.Cucumber.Framework/target/Workbook.xlsx");
	...
	public void i_submit_the_GET_request_as_per_the_data_in_Excel_Worksheet(String arg1) throws Throwable {
		...
		response = request.given().when().relaxedHTTPSValidation().get(endpoint);
